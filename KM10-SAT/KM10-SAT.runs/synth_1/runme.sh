...
HD_PWD='Z:/Documents/ECE-Reaserch/Solving-SAT-in-FPGA-UCSB/KM10-SAT/KM10-SAT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Address_Translation_Table_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Address_Translation_Table_tb.tcl
