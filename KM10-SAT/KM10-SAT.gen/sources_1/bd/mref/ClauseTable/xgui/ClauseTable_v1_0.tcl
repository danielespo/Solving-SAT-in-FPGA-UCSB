...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CLAUSE_ADDRESS_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.CLAUSE_ADDRESS_WIDTH { PARAM_VALUE.CLAUSE_ADDRESS_WIDTH } {
	# Procedure called to update CLAUSE_ADDRESS_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CLAUSE_ADDRESS_WIDTH { PARAM_VALUE.CLAUSE_ADDRESS_WIDTH } {
	# Procedure called to validate CLAUSE_ADDRESS_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.CLAUSE_ADDRESS_WIDTH { MODELPARAM_VALUE.CLAUSE_ADDRESS_WIDTH PARAM_VALUE.CLAUSE_ADDRESS_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CLAUSE_ADDRESS_WIDTH}] ${MODELPARAM_VALUE.CLAUSE_ADDRESS_WIDTH}
}
