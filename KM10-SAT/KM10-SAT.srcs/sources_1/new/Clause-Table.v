...
(
    ...
    input [LITERAL_ADDRESS_WIDTH-1:0]    address,    // n-bit number to address the clause 
    // clause[i][j] is the jth SAT variable w/ negation bit in the ith clause
    // negation bit is held in the MSB of the variable
    output reg [LITERAL_ADDRESS_WIDTH:0] clause [NUM_CLAUSES-1:0][NSAT-2:0]    // clause output
...
// negation bit is held in the MSB of the variable
reg [LITERAL_ADDRESS_WIDTH:0] clause_table [NUM_ROWS-1:0][NUM_CLAUSES-1:0][NSAT-2:0];
