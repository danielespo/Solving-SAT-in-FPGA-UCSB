...
HD_PWD='C:/Users/barry/Documents/Solving-SAT-in-FPGA-UCSB/Module_Dev/Module_Dev.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log validation_example_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source validation_example_wrapper.tcl
