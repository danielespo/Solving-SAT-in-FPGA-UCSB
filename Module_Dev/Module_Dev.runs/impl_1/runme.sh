...
HD_PWD='C:/Users/barry/Documents/Solving-SAT-in-FPGA-UCSB/Module_Dev/Module_Dev.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log validation_example_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source validation_example_wrapper.tcl -notrace
